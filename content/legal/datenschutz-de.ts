...
export const datenschutzSections: { title?: string; subtitle?: string; paragraphs: string[] }[] = [
  ...
  {
    title: 'Welche personenbezogenen Daten erfassen oder verarbeiten wir?',
    paragraphs: [
  ...
  {
    title: 'Quellen von personenbezogenen Daten',
    paragraphs: [
  ...
  {
    title: 'Wie verwenden wir Ihre personenbezogene Daten?',
    paragraphs: [
  ...
  {
    title: 'Wie geben wir personenbezogene Daten weiter?',
    paragraphs: [
  ...
  {
    title: 'Websites und Links von Drittanbietern',
    paragraphs: [
  ...
  {
    title: 'Sicherheit und Aufbewahrung Ihrer Daten',
    paragraphs: [
  ...
  {
    title: 'Ihre Rechte und Möglichkeiten',
    paragraphs: [
  ...
  },
  {
    title: 'Kontakt',
    paragraphs: [
      'Sollten Sie Fragen zu unseren Datenschutzverfahren oder dieser Datenschutzerklärung haben, oder wenn Sie eines der Ihnen zustehenden Rechte ausüben möchten, wenden Sie sich bitte telefonisch unter +352 621 178 877, per E-Mail unter info@eden-naturals.lu oder per Post an eden Sàrl, 1a Rue Albert 1Er, L-1117 Luxembourg, Luxemburg an uns. Im Sinne der geltenden Datenschutzgesetze sind wir der Datenverantwortliche für Ihre personenbezogenen Daten.',
    ],
  },
]
